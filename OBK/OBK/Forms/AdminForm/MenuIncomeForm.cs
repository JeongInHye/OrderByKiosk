...
namespace OBK.Forms.AdminForm
{
    public partial class MenuIncomeForm : Form
    {
        ...
        public MenuIncomeForm()
        {
            ...
            //Load += load.GetHandler("menuincome");
            Load += MenuIncomeForm_Load;
        }

        private void MenuIncomeForm_Load(object sender, EventArgs e)
        {
            if (AdminLoad.GetHandler(this, "menuincome"))
            {
                getView();
            }
        }
